            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {},
                    child: const Text("Switch to instructor view", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0, color: TColors.primary)),
                  ),
                ],
              ),
            ),
            Text("Video prefrences"),
            Container(
              margin: const EdgeInsets.symmetric(vertical: 8.0),
              padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 16.0),
              color: isDark ? TColors.black : TColors.white,
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  CustomTile(title: 'Push notifications'),
